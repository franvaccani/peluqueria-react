...
const PageContacto = () => {
  ...
  return (
    <div className="contenedorContacto">
      ...
      {/* Sección de contacto */}
      <div className="bg-[#1b1b1b] flex items-center h-[70vh] text-white py-16 px-8">
        <div className="font-poppins container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
